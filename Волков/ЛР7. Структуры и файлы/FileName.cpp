...
//Описать структуру для групп студентов.Поля структуры – произвольные.
//Необходимо вывести информацию о студентах, чьи фамилии начинаются на I, F.
//Данные вводятся с клавиатуры.Предусмотреть запись в файл
